...
- `patches/0526-dt-bindings-remoteproc-qcom-sm8550-pas-make-qcom-hawi-cdsp-pas-standalone.patch`
  source: https://patchwork.kernel.org/project/linux-arm-msm/patch/20260910150638.3270162-2-mukesh.ojha@oss.qualcomm.com/
  upstream: https://lore.kernel.org/r/20260910150638.3270162-2-mukesh.ojha@oss.qualcomm.com
  notes: Makes Hawi CDSP standalone and associates Maili CDSP fallback to Hawi. Reviewed-by Krzysztof Kozlowski, Acked-by Manivannan Sadhasivam.
- `patches/0527-remoteproc-qcom_q6v5_pas-add-per-PD-proxy-performance-states-for-Hawi-CDSP.patch`
  source: https://patchwork.kernel.org/project/linux-arm-msm/patch/20260910150638.3270162-3-mukesh.ojha@oss.qualcomm.com/
  upstream: https://lore.kernel.org/r/20260910150638.3270162-3-mukesh.ojha@oss.qualcomm.com
  notes: Introduces proxy_pd_performance_states array in qcom_pas_data to allow per-PD RPMH levels to be configured individually (e.g. NSP at NOM, CX/MXC at TURBO) rather than blanket INT_MAX. Uses dev_warn to prevent panic_on_warn panics. Reviewed-by Abel Vesa, Tested-by Yijie Yang.
